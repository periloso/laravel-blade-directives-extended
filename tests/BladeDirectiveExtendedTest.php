<?php
use Periloso\BladeDirectivesExtended\RussianCaching;
use Periloso\BladeDirectivesExtended\RussianBladeDirective;
class BladeDirectiveTest extends TestCase
{
    ...
    function it_can_use_a_string_as_the_cache_key()
    {
        ...
        $directive = new RussianBladeDirective($doll->reveal());
    ...
    protected function createNewCacheDirective()
    {
        ...
        return new RussianBladeDirective($this->doll);
    }
}
